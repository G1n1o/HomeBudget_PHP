        ...
        <div class="hero">
            ...
            <div class="hero-main">
                ...
                <div class="hero-main-text">
                    ...
                    <form class="form" method="post" action="balance.php">
                        <h1>
                        ...
                        <div class="id">
                            <div class="input-icons">
                                ...
                                <div class="icon-center">
                                    ...
                                    <?php 
                                        if(isset($_SESSION['inputedEmail'])) {
                                            echo 'value="'.$_SESSION['inputedEmail'].'"';
                                            unset($_SESSION['inputedEmail']);
                                        }
                                        ?>>
                        ...
                        <div class="buttons">
                            <input type="submit" value="Zaloguj" class="btn blue-btn">
                        </div>
                    </form>
